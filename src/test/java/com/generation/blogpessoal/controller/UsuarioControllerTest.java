...
public class UsuarioControllerTest {
	...
	public void naoDeveDuplicarUsuario() {		
		...
		usuarioService.cadastrarUsuario(new Usuario(0L,"Giovana","giovana@gmail.com","123456", "-"));
		
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(new Usuario(0L,"Giovana","giovana@gmail.com","123456", "-"));
	...
	public void deveAtualizarUmUsuario() {
		...
		Optional<Usuario> usuarioCadastrado = usuarioService.cadastrarUsuario(new Usuario
				(0L,"Ellen Silva","ellen@gmail.com", "ellen123","-"));
		
		Usuario usuarioUpdate = new Usuario(usuarioCadastrado.get().getId(),
				"Ellen Pereira Silva","ellen@gmail.com", "ellen123","-");
	...
	public void deveMostrarTodosUsuarios() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L, "Anabela","anabela@gmail.com","ana123","-"));
		
		usuarioService.cadastrarUsuario(new Usuario(0L, "Bruno","bruno@gmail.com","bruno123","-"));
